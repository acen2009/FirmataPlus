...
byte  encoderMSB = 0, encoderLSB = 0, encoderHLSB = 0, encoderHMSB = 0, encoderLastB = 0;     // sysex data registers
...
void loop()
{
  ...
  if (currentMillis - previousMillis > samplingInterval) {
    ...
    if ( encoderPresent == true)
    {
      ...
      encoderLSB = encoderPostion & 0xFF;
      encoderMSB = (encoderPostion >> 8) & 0xFF;
      encoderHLSB = (encoderPostion >> 16) & 0xFF;
      encoderHMSB = (encoderPostion >> 24) & 0xFF;
